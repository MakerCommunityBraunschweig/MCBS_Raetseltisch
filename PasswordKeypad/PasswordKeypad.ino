...
#define SoftwareVersion "201802151909"  // IMMER AKTUALISIEREN YYYYMMDDHHMM
...
unsigned int check_3 = 1; //Variable um Raetselspiel zu aktivieren, 0 = aus
